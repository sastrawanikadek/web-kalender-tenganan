...
const Datepicker = (props) => {
  ...
  const modes = [...new Set(props.modes)];
          ...
          <div className={classes.modalHeader}>
            {findMode("year") !== -1 && (
              <Button
                ...
                fullWidth={modes.length === 1}
              >
                <Text
                  variant={modes.length === 1 ? "h3" : "body"}
            ...
            {findMode("date") === -1 && findMode("month") !== -1 && (
              <Button
                className={classes.headerButton}
              ...
              >
                <Text
                  color={
                    mode === "month" ? "white" : "rgba(255, 255, 255, 0.7)"
                  }
                  variant="h3"
                  noMargin
                >
                  {format(selectedDate, "MMMM", { locale: id })}
                </Text>
              </Button>
            )}
            {findMode("date") !== -1 && (
